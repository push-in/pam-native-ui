...
- samples: 10,000 host updates, 10,000 slider moves, 2,000 calendar
  draws, 10,000 DateTimePicker updates and 2,000 host lifecycles;
- warm-up: 1,000 host updates, 1,000 DateTimePicker updates and 200
  calendar draws.

| Operation | p50 | p95 | p99 | max |
| --- | ---: | ---: | ---: | ---: |
| Decode/apply native host update | 14 µs | 33 µs | 42 µs | 113 µs |
| Slider move and local redraw | 8 µs | 18 µs | 26 µs | 2,105 µs |
| Calendar grid draw | 1,170 µs | 1,257 µs | 1,297 µs | 1,407 µs |
| DateTimePicker property update | 19 µs | 24 µs | 37 µs | 2,005 µs |
| Create, update and release host | 101 µs | 123 µs | 157 µs | 1,697 µs |
...
instrumented benchmark fails when update, DateTimePicker update, gesture or
calendar draw p99 exceeds 4 ms, or lifecycle p99 exceeds 8 ms. Run it on a
connected device:
