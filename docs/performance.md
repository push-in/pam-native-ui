...
- samples: 10,000 updates, 10,000 slider moves, 2,000 calendar draws,
  2,000 host lifecycles;
- warm-up: 1,000 updates and 200 calendar draws.

| Operation | p50 | p95 | p99 | max |
| --- | ---: | ---: | ---: | ---: |
| Decode/apply native host update | 14 µs | 50 µs | 65 µs | 718 µs |
| Slider move and local redraw | 13 µs | 19 µs | 24 µs | 215 µs |
| Calendar grid draw | 1,190 µs | 1,278 µs | 1,318 µs | 2,542 µs |
| Create, update and release host | 92 µs | 120 µs | 146 µs | 497 µs |
...
events. The instrumented benchmark fails when update, gesture or calendar draw
p99 exceeds 4 ms, or lifecycle p99 exceeds 8 ms. Run it on a connected device:
