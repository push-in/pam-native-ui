...
final class Themes
{
    ...
    public static function pamLight(): Theme
    {
        return self::$pamLight ??= self::light()->withColors([
            ColorToken::Primary->value => Color::rgb(7, 122, 80),
            ColorToken::PrimaryForeground->value => Color::rgb(255, 255, 255),
            ColorToken::Card->value => Color::rgb(255, 255, 255),
            ColorToken::Secondary->value => Color::rgb(108, 79, 248),
            ColorToken::SecondaryForeground->value => Color::rgb(255, 255, 255),
            ColorToken::Background->value => Color::rgb(247, 249, 255),
            ColorToken::Popover->value => Color::rgb(255, 255, 255),
            ColorToken::PopoverForeground->value => Color::rgb(15, 23, 42),
            ColorToken::Muted->value => Color::rgb(237, 234, 255),
            ColorToken::MutedForeground->value => Color::rgb(77, 85, 111),
            ColorToken::Destructive->value => Color::rgb(225, 29, 72),
            ColorToken::Foreground->value => Color::rgb(15, 23, 42),
            ColorToken::Border->value => Color::rgb(211, 216, 231),
            ColorToken::Input->value => Color::rgb(181, 190, 211),
            ColorToken::Ring->value => Color::rgb(7, 122, 80),
            ColorToken::Accent->value => Color::rgb(216, 250, 236),
            ColorToken::AccentForeground->value => Color::rgb(5, 92, 58),
            ColorToken::DestructiveForeground->value => Color::rgb(255, 255, 255),
            ColorToken::Surface->value => Color::rgb(247, 249, 255),
            ColorToken::SurfaceElevated->value => Color::rgb(255, 255, 255),
            ColorToken::SurfaceSunken->value => Color::rgb(238, 241, 250),
            ColorToken::Success->value => Color::rgb(4, 120, 87),
            ColorToken::SuccessForeground->value => Color::rgb(255, 255, 255),
            ColorToken::Warning->value => Color::rgb(194, 65, 12),
            ColorToken::WarningForeground->value => Color::rgb(255, 255, 255),
            ColorToken::Info->value => Color::rgb(37, 99, 235),
            ColorToken::InfoForeground->value => Color::rgb(255, 255, 255),
            ColorToken::Focus->value => Color::rgb(7, 122, 80),
            ColorToken::Overlay->value => Color::rgb(15, 23, 42, 140),
            ColorToken::OnSurface->value => Color::rgb(15, 23, 42),
            ColorToken::Outline->value => Color::rgb(91, 101, 126),
            ColorToken::OutlineVariant->value => Color::rgb(181, 190, 211),
            ColorToken::SurfaceContainerLowest->value => Color::rgb(255, 255, 255),
            ColorToken::SurfaceContainerLow->value => Color::rgb(242, 244, 255),
            ColorToken::SurfaceContainer->value => Color::rgb(235, 238, 252),
            ColorToken::SurfaceContainerHigh->value => Color::rgb(227, 231, 248),
            ColorToken::SurfaceContainerHighest->value => Color::rgb(218, 224, 243),
            ColorToken::InverseSurface->value => Color::rgb(37, 48, 40),
            ColorToken::InverseOnSurface->value => Color::rgb(238, 245, 239),
            ColorToken::InversePrimary->value => Color::rgb(103, 232, 178),
        ]);
    }
    ...
    public static function pamDark(): Theme
    {
        return self::$pamDark ??= self::dark()->withColors([
            ...
            ColorToken::Secondary->value => Color::rgb(190, 178, 255),
            ColorToken::SecondaryForeground->value => Color::rgb(40, 30, 92),
            ...
            ColorToken::Warning->value => Color::rgb(255, 143, 118),
